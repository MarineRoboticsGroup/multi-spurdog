...
class CycleManager:
    ...
    def __init__(self):
        ...
        # Landmarks may be provided via ROS params (preferred). Default to the
        # previously-hardcoded positions for backwards compatibility.
        # Previous (legacy) literal assignment preserved below for reference:
        # self.landmarks = {"L0":[-74.5193539608157,-38.9298973079931,-1.83], "L1":[66.5150726324041,25.969767675496275,-1.83]}
